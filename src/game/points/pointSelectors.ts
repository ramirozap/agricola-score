...
export const getFieldsPoints = createSelector(fields, fieldsPoints);
...
export const getGrainsPoints = createSelector(grains, grainSheepsPoints);
...
export const getSheepsPoints = createSelector(sheeps, grainSheepsPoints);

export const getBoarsPoints = createSelector(boars, boarsPoints);

export const getCattlesPoints = createSelector(cattles, cattlesPoints);
...
export const getFencedStablesPoints = createSelector(fencedStables, identity);

export const getClayRoomsPoints = createSelector(clayRooms, identity);

export const getStoneRoomsPoints = createSelector(stoneRooms, stoneRoomsPoints);
...
export const getBonusPoints = createSelector(bonus, identity);

export const getCardsPoints = createSelector(cards, identity);
